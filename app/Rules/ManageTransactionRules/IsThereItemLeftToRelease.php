...
class IsThereItemLeftToRelease implements Rule
{
    private $request;
    ...
    {
        $approvedItemCount = BorrowedItem::where('borrowing_transac_id', $this->request['transactionId'])
            ->where('borrowed_item_status_id', $this->approvedStatusId)
            ->count();
    ...
    {
        return 'No more items left to release';
    }
}